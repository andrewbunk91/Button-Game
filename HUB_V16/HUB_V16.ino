...
// CHANGE: Forward declaration prevents Arduino's autogenerated prototypes from
// referencing ResetEvent before its definition.
...
// CHANGE: Update pin mapping to actual relay pin.
#define RELAY_PIN 37  // GPIO driving the relay module
